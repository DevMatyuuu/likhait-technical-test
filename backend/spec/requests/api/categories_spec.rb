...
RSpec.describe "Api::Categories", type: :request do
  describe "GET /api/categories" do
    ...
    it "returns all categories" do
      ...
      expect(json.map { |c| c["name"] })
        .to include("Food", "Transport", "Supplies")

      expect(json.map { |c| c["emoji"] })
        .to include("🍔", "🚌", "📦")
    end
    ...
    it "returns categories in alphabetical order" do
      ...
      expect(json.map { |c| c["name"] })
        .to eq([ "Food", "Supplies", "Transport" ])
    end
  end

  describe "POST /api/categories" do
    it "creates a category with emoji" do
      expect {
    ...
    it "creates a category without emoji" do
      post "/api/categories", params: {
        category: {
          name: "Utilities"
        }
      ...
      expect(json["name"]).to eq("Utilities")
      expect(json["emoji"]).to be_nil.or eq("")
    end
